...
('Produto X', 'Nacional', 10,100, NOW(), 1, 25.99);
INSERT INTO produtos (prd_nome, mrc_nacionalidade, prd_qtd_estoque, prd_estoque_min, prd_data_fabricacao, prd_perecivel, prd_valor) VALUES
('Produto Y', 'Importado', 50, 5, NOW(), 0, 35.50);
INSERT INTO produtos (prd_nome, mrc_nacionalidade, prd_qtd_estoque, prd_estoque_min, prd_data_fabricacao, prd_perecivel, prd_valor) VALUES
('Produto Z', 'Nacional', 7, 75, NOW(), 1, 19.99);
INSERT INTO produtos (prd_nome, mrc_nacionalidade, prd_qtd_estoque, prd_estoque_min, prd_data_fabricacao, prd_perecivel, prd_valor) VALUES
('Produto A', 'Importado', 30, 3, NOW(), 0, 49.99);
INSERT INTO produtos (prd_nome, mrc_nacionalidade, prd_qtd_estoque, prd_estoque_min, prd_data_fabricacao, prd_perecivel, prd_valor) VALUES
('Produto B', 'Nacional', 6, 60, NOW(), 1, 29.99);
...
CREATE VIEW Tabela_Abaixo_media AS 
SELECT * FROM produtos WHERE prd_qtd_estoque < prd_estoque_min;

SELECT * FROM Tabela_Abaixo_media;
